...
AmountWithdraw = Label(t, text="Amount in figures", font=("Arial", 20), bg="Maroon", fg="white")
...
AmountWithdraw_words = Label(t, text="Amount in words", font=("Arial", 20), bg="red", fg="white")
AmountWithdraw_words.place(relx=0.2, rely=0.64, anchor=CENTER)
Amount2 = Entry(t, font=("Arial", 15), bg="white", fg="black")
Amount2.place(relx=0.7, rely=0.64, anchor=CENTER)

withdraw_button = Button(t, text="Withdraw", command= insertdata, font=("Arial", 20), bg="green", fg="white")
withdraw_button.place(relx=0.5, rely=0.8, anchor=CENTER)
