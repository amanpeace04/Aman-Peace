...
contact_button = tk.Button(t, text="Contact Us", command= contactus, font=("Arial", 20), bg="lightgreen", fg="brown")
...
connect_button.place(relx=0.5, rely=0.4, anchor=tk.CENTER)

Fb = tk.Button(t, text="Facebook ", font=("Arial", 20), bg="lightblue", fg="white")
Fb.place(relx=0.5, rely=0.5, anchor=tk.CENTER)

Insta = tk.Button(t, text="Instagram ", font=("Arial", 20), bg="pink", fg="white")
Insta.place(relx=0.5, rely=0.6, anchor=tk.CENTER)

Twitter = tk.Button(t, text="Twitter ", font=("Arial", 20), bg="black", fg="white")
Twitter.place(relx=0.5, rely=0.7, anchor=tk.CENTER)
