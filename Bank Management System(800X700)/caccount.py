...
def insertdata():
    ...
    if not all([name_val, accno_val, mobile_val, address_val, pincode_val, acctype_val]):
    ...
    c.execute("INSERT INTO accounts (accno, name, mobile, address, pincode, acctype, balance) VALUES (%s, %s, %s, %s, %s, %s, %s)",
              (accno_val, name_val, mobile_val, address_val, pincode_val, acctype_val, bal))
    connection.commit()
